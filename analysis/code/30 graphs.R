...
packages <- c('tidyverse','reshape2') ## you can add more packages here
...
# years <- as.character(2016)

read_one_year_processed_xml <- function(year) {
  
  filename <- here::here("store", "processed_xml_bottom_up", paste0("processed_xml_", year, ".rda"))
